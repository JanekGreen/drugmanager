...
public class NewDrugInfoActivity extends AppCompatActivity implements DefinedTimeAdapter.SwitchChangeCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drugViewModel.getDrugData().observe(this, drug -> {
            if (drug != null) {
                System.out.println("Get drug data fired");
                DrugDb drugDb = TypeConverter.makeDrugDatabaseEntity(drug);
                initializeView(drugDb);
            }
        });
