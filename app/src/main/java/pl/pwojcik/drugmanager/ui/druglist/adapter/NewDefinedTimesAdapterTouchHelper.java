...
public class NewDefinedTimesAdapterTouchHelper extends ItemTouchHelper.SimpleCallback {
    private final RecyclerItemTouchHelperListener listener;


    public NewDefinedTimesAdapterTouchHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
